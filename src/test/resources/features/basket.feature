Feature: Want a basket to print out correctly
  ...
  Scenario: Basket without promotion out of date range
    ...
    Then The console output matches the contents of the file 'src/test/resources/fixtures/input/basket_out_of_date_range_output.txt'.
  ...
  Scenario: Basket with apple only promotion
    ...
    Then The console output matches the contents of the file 'src/test/resources/fixtures/input/basket_apple_only_promotion_output.txt'.
  ...
  Scenario: Basket with soup and apple promotion
    ...
    Then The console output matches the contents of the file 'src/test/resources/fixtures/input/basket_soup_and_apple_promotion_output.txt'.
  ...
  Scenario: Basket with soup promotion
    ...
    Then The console output matches the contents of the file 'src/test/resources/fixtures/input/basket_soup_promotion_output.txt'.
  ...
  Scenario: Basket without promotion not eligible products
    ...
    Then The console output matches the contents of the file 'src/test/resources/fixtures/input/basket_no_promotion_output.txt'.
